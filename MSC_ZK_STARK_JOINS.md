...
2.  **Faster Joins (MSC3902):** The server temporarily *blindly trusts* the remote server's assertion of the "current state" so users can participate immediately. In the background, it syncs the multi-gigabyte Auth Chain. This compromises the immediate trustless nature of the network.
